        ...
        <div className="section-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative order-2 lg:order-1 reveal reveal-left">
              ...
              {/* Floating Badge */}
              <div className="absolute -bottom-6 -right-6 md:right-8 glow-card p-6 bg-card/95 backdrop-blur-sm reveal reveal-zoom reveal-delay-300">
            ...
            <div className="order-1 lg:order-2 reveal reveal-right">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p className="reveal reveal-up reveal-delay-100">
                ...
                <p className="reveal reveal-up reveal-delay-200">
                ...
                <p className="reveal reveal-up reveal-delay-300">
              ...
              <div className="mt-8 p-6 rounded-xl bg-accent/10 border border-accent/30 reveal reveal-up reveal-delay-400">
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <div
                key={value.title}
                className="glow-card p-6 text-center reveal reveal-up"
